...
public class HomeOwnerMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuItem defaultItem = nvDrawer.getMenu().getItem(0);
        selectDrawerItem(defaultItem);
    }
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.nav_bookings:
                fragmentClass = HomeOwnerBookingListFragment.class;
                break;
            case R.id.nav_ratings:
                fragmentClass = HomeOwnerRatingListFragment.class;
                break;
            default:
                fragmentClass = HomeFragment.class;
        }
